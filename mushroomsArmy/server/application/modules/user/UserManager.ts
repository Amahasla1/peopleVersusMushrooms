...
class UserManager extends BaseManager {
    ...
    private async socketLobbyStart(data: { guid?: string; token?: string } = {}, socket: Socket): Promise<void> {
        ...
        const buildings = [
            ...
            { guid: this.common.guid(), type: 'sporovaya_bashnya', x: 12, y: 12, hp: 500, maxHp: 500, sizeX: 2, sizeY: 2 },
            { guid: this.common.guid(), type: 'sporovaya_bashnya', x: 16, y: 18, hp: 500, maxHp: 500, sizeX: 2, sizeY: 2 },
        ];
